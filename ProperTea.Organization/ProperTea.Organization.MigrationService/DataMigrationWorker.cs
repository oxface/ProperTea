...
namespace ProperTea.Organization.MigrationService;
    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    ...
    private static async Task RunMigrationAsync(OrganizationDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task SeedDataAsync(OrganizationDbContext dbContext, CancellationToken cancellationToken)
    {
        var strategy = dbContext.Database.CreateExecutionStrategy();
        await strategy.ExecuteAsync(async () =>
        {
