...
{
    public CosmosOrganizationRepository(CosmosClient cosmosClient, string databaseName, string containerName,
        string partitionKey = "/id")
        : base(cosmosClient, databaseName, containerName, partitionKey)
    {
    }

    public async Task<Domain.Organizations.Organization?> GetByNameAsync(string name,
