    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var dbContext = scope.ServiceProvider.GetRequiredService<SystemOwnerDbContext>();
    ...
    private static async Task RunMigrationAsync(SystemOwnerDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task SeedDataAsync(SystemOwnerDbContext dbContext, CancellationToken cancellationToken)
    {
        var strategy = dbContext.Database.CreateExecutionStrategy();
        await strategy.ExecuteAsync(async () =>
        {
